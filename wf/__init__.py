...
def batch_assembly_task(
    ...
    version = Path(f"/root/version.txt")
    _version_cmd = ["./shasta", "--version"]
    
    with open(version, "w") as f:
        subprocess.run(_version_cmd, stdout=f, stderr=f)
...
def shasta(
    input_dir: LatchDir,
    config: List[str] = ['HiFi-Oct2021', 'Nanopore-Dec2019', 'Nanopore-Jun2020', 'Nanopore-Oct2021', 'Nanopore-OldGuppy-Sep2020', 'Nanopore-Phased-Aug2021', 'Nanopore-Plants-Apr2021', 'Nanopore-Sep2020', 'Nanopore-UL-Dec2019', 'Nanopore-UL-Jun2020', 'Nanopore-UL-Oct2021', 'Nanopore-UL-Phased-Oct2021', 'Nanopore-UL-Sep2020', 'Nanopore-UL-iterative-Sep2020'],
) -> LatchFile:
    ...
    **For quick start information see [here](https://chanzuckerberg.github.io/shasta/QuickStart.html).**
    ...
    # demo for now
    return batch_assembly_task(input_dir=input_dir, config=config)
